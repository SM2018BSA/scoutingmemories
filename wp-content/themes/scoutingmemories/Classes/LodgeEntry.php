...
class LodgeEntry extends Entry {
	...
	public function __construct(int $entry_id = 0) {
		...
		if ($entry_id) {
			...
			$this->name = array_key_exists('al_lodge_name', $this->entry_array) ? $this->entry_array['al_lodge_name'] : '';
			$this->number = array_key_exists('al_lodge_number', $this->entry_array) ? $this->entry_array['al_lodge_number'] : '';
			$this->slug = array_key_exists('al_lodge_slug', $this->entry_array) ? $this->entry_array['al_lodge_slug'] : '';
			$this->active = array_key_exists('al_lodge_active', $this->entry_array) ? $this->entry_array['al_lodge_active'] : '';
			$this->start = array_key_exists('al_lodge_start', $this->entry_array) ? $this->entry_array['al_lodge_start'] : '';
			$this->end = array_key_exists('al_lodge_end', $this->entry_array) ? $this->entry_array['al_lodge_end'] : '';
			$this->lodge_state = array_key_exists('al_lodge_state', $this->entry_array) ? $this->entry_array['al_lodge_state'] : '';
			$this->lodge_state_val = array_key_exists('al_lodge_state-value', $this->entry_array) ? $this->entry_array['al_lodge_state-value'] : '';

			$this->get_state_slugs();

			if (!is_array($this->lodge_state_slugs)) {
				$this->lodge_state_slugs = array($this->lodge_state_slugs);
			}

			$this->council_state = array_key_exists('al_council_state', $this->entry_array) ? $this->entry_array['al_council_state'] : '';
			$this->council_state_val = array_key_exists('al_council_state-value', $this->entry_array) ? $this->entry_array['al_council_state-value'] : '';
			$this->council_names = array_key_exists('al_council_name', $this->entry_array) ? $this->entry_array['al_council_name'] : '';
			$this->council_names_val = array_key_exists('al_council_name-value', $this->entry_array) ? $this->entry_array['al_council_name-value'] : '';
			$this->author_uid = array_key_exists('al_user_id', $this->entry_array) ? $this->entry_array['al_user_id'] : '';
			$this->author_uid_val = array_key_exists('al_user_id-value', $this->entry_array) ? $this->entry_array['al_user_id-value'] : '';
	...
	public static function get_lodge_name($lodge_slug) {
		...
		if (isset($entry->entry_array) && is_array($entry->entry_array) && array_key_exists('al_lodge_name', $entry->entry_array)) {
