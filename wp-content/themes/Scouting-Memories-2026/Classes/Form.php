...
//		return FrmFormsController::get_form_shortcode(array('id' => $this->form_id, 'title' => $title, 'description' => $description) );
//	}
    public function show_form( $title = false, $key = false) {
        return FrmFormsController::show_form( $this->form_id, $key, $title );
    }
