jQuery(document).ready(function () {
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                select.html(select.find('option').sort(function (x, y) {
                    ...
                    const options = []
                    document.querySelectorAll('#select_council > option').forEach((option) => {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    select.html(select.find('option').sort(function (x, y) {
                        ...
                        //your callback logic / code here
                        const options = []
                        document.querySelectorAll('#select_merged_council > option').forEach((option) => {
                            if (options.includes(option.value)) option.remove()
                            else options.push(option.value)
                        });
    ...
    jQuery('#select_merged_council').on('change', function () {
        ...
        //console.log("selected_councils.length: "+ selected_councils.length);
