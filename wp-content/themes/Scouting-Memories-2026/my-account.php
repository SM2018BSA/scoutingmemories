                    ...
                    <div class="col col-sm-9">
                        ...
                        <div id="main-tabs" class="tab-content">
                            <div id="myAccount" class="tab-pane active" role="tabpanel" aria-labelledby="myAccount-tab">
                                <div class="container">
                                    <?php
                                    if (shortcode_exists('sm_account_profile')) {
                                        echo do_shortcode('[sm_account_profile]');
                                    } elseif (isset($myAccountForm)) {
                                        echo $myAccountForm->show_form();
                                    }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div id="myPosts" class="tab-pane  fade" role="tabpanel" aria-labelledby="myPosts-tab">
                                <?php if ($the_user->cap_allowed('create_posts')) { ?>
                                    ...
                                    <div class="container">
                                        <?php
                                        if (shortcode_exists('sm_user_posts')) {
                                            echo do_shortcode('[sm_user_posts]');
                                        } else {
                                        ?>
                                        <div class="row ">
                                            <div class="col p-3">
                                ...
                                <?php if ($the_user->cap_allowed('create_posts')) { ?>
                                    <div class="container">
                                        <div class="row ">
                                            <div class="col p-3">
                                                <?php
                                                if (shortcode_exists('sm_user_defaults')) {
                                                    echo do_shortcode('[sm_user_defaults]');
                                                } elseif (isset($editUserDefaultsForm)) {
                                                    echo '<p>' . $editUserDefaultsForm->show_form() . '</p>';
                                                }
                                                ?>
                                            </div>
                                        </div>
                            ...
                            <div id="myIndexing" class="tab-pane -fluid fade">
                                <div class="container">
                                    <?php if ($the_user->role_allowed('index_contributor')) { ?>
                                        <?php
                                        if (shortcode_exists('sm_indexing_browser')) {
                                            echo do_shortcode('[sm_indexing_browser]');
                                        } else {
                                        ?>
                                        <div class="row ">
                                            <div class="col p-3">
