...
<div id="page-container"<?php echo et_core_intentionally_unescaped($page_container_style, 'fixed_string'); ?>>
    ...
    <header id="main-header" data-height-onload="<?php echo esc_attr(et_get_option('menu_height', '66')); ?>">
        ...
        <div class="container clearfix et_menu_container">
            ...
            <div id="top-banner" ><a href="http://www.scoutingalumni.org/site/c.ejIPK1NNLgJ0E/b.9309477/k.BF3E/Home.htm"
                                    target="_blank">
                    <img src="//storage.scoutingmemories.org/2019/03/e52d5880-scouting-alumni-banner.png" height="80"
                         width="315"/>
                </a>
            </div>
            <?php
