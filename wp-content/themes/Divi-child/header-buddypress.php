...
<div id="page-container"<?php echo $page_container_style; ?>>
	...
	<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
		<div id="top-banner"><a href="http://www.scoutingalumni.org/site/c.ejIPK1NNLgJ0E/b.9309477/k.BF3E/Home.htm" target="_blank">
				<img src="/scouting-memories/wp-content/uploads/2017/12/scouting-alumni-banner.png" height="80" width="315"/>
			</a> </div>
