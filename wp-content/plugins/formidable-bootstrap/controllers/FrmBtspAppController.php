...
class FrmBtspAppController{
    ...
    */
    ...
    public static function field_options($field, $display, $values){
		...
		$field_types = array( 'phone', 'number', 'text', 'email', 'url', 'date', 'image', 'tag', 'password', 'select' );
    ...
    public static function front_head() {
		...
		wp_register_style('bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css', array(), '4.3.1');
