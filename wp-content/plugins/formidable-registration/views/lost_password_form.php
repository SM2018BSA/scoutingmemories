...
<div id="<?php echo esc_attr( $form->get_html_id() ); ?>" class="<?php echo esc_attr( $form->get_class() ); ?>">
	...
	<form id="lostpasswordform_<?php echo esc_attr( $form->get_form_number() ); ?>" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post" class="frm-show-form">
